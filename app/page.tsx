...
export default function HomePage() {
  return (
    <div className="bg-[#020617]">
      ...
      <section
        id="how-it-works"
        className="scroll-mt-24 mx-auto grid max-w-6xl gap-4 px-6 pb-16 md:grid-cols-3"
      >
      ...
      <section
        id="processes"
        className="scroll-mt-24 mx-auto max-w-6xl space-y-4 px-6 pb-16"
      >
        <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
      ...
      <section
        id="confidentiality"
        className="scroll-mt-24 mx-auto max-w-6xl px-6 pb-12"
      >
        <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
      ...
      <section
        id="contact"
        className="scroll-mt-24 mx-auto max-w-6xl grid gap-6 px-6 pb-20 md:grid-cols-[1.1fr_minmax(0,1fr)]"
      >
        <div>
          <h2 className="text-base font-semibold text-white">
